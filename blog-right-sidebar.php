                ...
                <div class="ms-blogs-rightside col-lg-8 col-md-12">
                    ...
                    <div class="ms-blogs-content">
                        <div class="ms-blogs-inner">
                            <div class="row">
                                <div class="col-md-6 col-sm-12 mb-6 ms-blog-block">
                                    <div class="ms-blog-item">
                                        <div class="news-info">
                                            ...
                                            <div class="detail">
                                                ...
                                                <p class="text-length">"Lorem Ipsum is simply dummy text of the printing and typesetting
                                                    industry.</p>
                                                <div class="more-info">
                                                    <a href="blog-detail-left-sidebar.php">Read More<span></span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
