...
?>
    ...
    <section class="ms-single-product padding-b-30">
        <div class="container">
            <div class="row">
                <div class="ms-pro-rightside ms-common-rightside col-lg-9 col-md-12">
                            ...
                            <div class="row">
                                    ...
                                    <div class="single-product-scroll">
                                        <div class="single-product-cover">
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assets/img/product-images/4_1.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assets/img/product-images/2_1.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assets/img/product-images/3_1.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assets/img/product-images/1_1.jpg"
                                                    alt="">
                                            </div>
                                            <div class="single-slide zoom-image-hover">
                                                <img class="img-responsive" src="assets/img/product-images/5_1.jpg"
                                                    alt="">
                                            </div>
                                        </div>
                                ...
                                <div class="single-pro-desc m-t-991">
                                    <div class="single-pro-content">
                                        <h5 class="ms-single-title">Crunchy potato chips cheese flavour, 1 kg (2 x 500g) pack.</h5>
                                        <div class="ms-single-rating-wrap">
                                            ...
                                            <span class="ms-read-review">
                                                |&nbsp;&nbsp;<a href="#ms-spt-nav-review">992 Ratings</a>
                                            </span>
                                        </div>
                                        
                                        <div class="ms-single-price-stoke">
                                            <div class="ms-single-price">
                                                <div class="final-price">$664.00<span class="price-des">-78%</span></div>
                                                <div class="mrp">M.R.P. : <span>$2,999.00</span></div>
                                            </div>
                                            <div class="ms-single-stoke">                                                
                                                <span class="ms-single-sku">SKU#: WH12</span>
                                                <span class="ms-single-ps-title">IN STOCK</span>
                                            </div>
                                        </div>
                                        <div class="ms-single-desc">Lorem Ipsum is simply dummy text of the printing and
                                            typesetting industry. Lorem Ipsum has been the industry's standard dummy
                                            text ever since the 1990.</div>

                                        <div class="ms-single-list">
                                            <ul>
                                        ...
                                        <div class="ms-single-qty">
                                            ...
                                            <div class="ms-single-cart">
                                                <button class="btn btn-primary ms-btn-2">Add To Cart</button>
                                            </div>
                                            <div class="ms-single-wishlist">
                                                <a class="ms-btn-group wishlist" title="Wishlist">
                                                    <img src="assets/img/icons/wishlist.svg" class="svg_img pro_svg" alt="">
                                                </a>
                                            </div>
                                            <div class="ms-single-quickview">
                                                <a href="#" class="ms-btn-group quickview" data-link-action="quickview" title="Quick view" data-bs-toggle="modal" data-bs-target="#ms_quickview_modal">
                                                    <img src="assets/img/icons/quickview.svg" class="svg_img pro_svg" alt="">
                                                </a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="single-add-more m-tb-30">
                        <div class="ms-add-more-slider owl-carousel">
                            <div class="add-more-item">
                                <a href="javascript:void(0)" class="ms-btn-2">+</a>
                        ...
                        <div class="ms-single-pro-tab-wrapper">
                            <div class="ms-single-pro-tab-nav">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item">
                                        <a class="nav-link active" data-bs-toggle="tab" data-bs-target="#ms-spt-nav-details" role="tab">Detail</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#ms-spt-nav-info" role="tab">Specifications</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#ms-spt-nav-vendor" role="tab">Vendor</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-bs-toggle="tab" data-bs-target="#ms-spt-nav-review" role="tab">Reviews</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="tab-content  ms-single-pro-tab-content">
                                ...
                                <div id="ms-spt-nav-info" class="tab-pane fade">
                                ...
                                <div id="ms-spt-nav-vendor" class="tab-pane fade">
                                    <div class="ms-single-pro-tab-moreinfo">
                                        <div class="ms-product-vendor">
                                            ...
                                            <div class="ms-detail">
                                                <ul>
                                                    ...
                                                    <li><span>Address. :</span> 2548 Broaddus Maple Court, Madisonville KY 4783, USA.</li>
                                                </ul>
                                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                                                    Lorem Ipsum has been the industry's standard dummy text ever since the
                                                    1500s, when an unknown printer took a galley of type and scrambled it to
                                ...
                                <div class="ms-product-content">
                                    <div class="ms-product-inner">
                                        <div class="ms-pro-image-outer">
                                            <div class="ms-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    ...
                                                    <img class="main-image" src="assets/img/product-images/30_1.jpg"
                                                        alt="Product">
                                                    <img class="hover-image" src="assets/img/product-images/30_1.jpg"
                                                        alt="Product">
                                                </a>
                                                <span class="flags">
                                                ...
                                                <div class="ms-pro-actions">
                                                    <a href="javascript:void(0)" class="ms-btn-group wishlist"
                                                        title="Wishlist"><img src="assets/img/icons/pro_wishlist.svg"
                                        ...
                                        <div class="ms-pro-content">
                                            ...
                                            <h5 class="ms-pro-title"><a href="product-left-sidebar.php">Banana Chips
                                                    Snack</a></h5>
                                ...
                                <div class="ms-product-content">
                                    <div class="ms-product-inner">
                                        ...
                                        <div class="ms-pro-content">
                                            ...
                                            <h5 class="ms-pro-title"><a href="product-left-sidebar.php">Onion -
                                                    Hybrid</a></h5>
                                            <div class="ms-pro-rat-price">
                                                <span class="ms-pro-rating">
                                                    <i class="msicon msi-star fill"></i>
                                ...
                                <div class="ms-product-content">
                                    <div class="ms-product-inner">
                                        ...
                                        <div class="ms-pro-content">
                                            ...
                                            <h5 class="ms-pro-title"><a href="product-left-sidebar.php">Dates Value
                                                    Pouch</a></h5>
                                            <div class="ms-pro-rat-price">
                                                <span class="ms-pro-rating">
                                                    <i class="msicon msi-star fill"></i>
                                ...
                                <div class="ms-product-content">
                                    <div class="ms-product-inner">
                                            ...
                                            <div class="ms-pro-image">
                                                <a href="product-left-sidebar.php" class="image">
                                                    ...
                                                    <img class="main-image" src="assets/img/product-images/19_1.jpg"
                                                        alt="Product">
                                                    <img class="hover-image" src="assets/img/product-images/19_1.jpg"
                                                        alt="Product">
                                                </a>
                                                <div class="ms-pro-actions">
                                                    <a href="javascript:void(0)" class="ms-btn-group wishlist"
                                        ...
                                        <div class="ms-pro-content">
                                            ...
                                            <h5 class="ms-pro-title"><a href="product-left-sidebar.php">Farm Eggs -
                                                    Brown</a></h5>
                                            <div class="ms-pro-rat-price">
                                                <span class="ms-pro-rating">
                                                    <i class="msicon msi-star fill"></i>
                                ...
                                <div class="ms-product-content">
                                    <div class="ms-product-inner">
                                        ...
                                        <div class="ms-pro-content">
                                            ...
                                            <h5 class="ms-pro-title"><a href="product-left-sidebar.php">Ginger -
                                                    Organic</a></h5>
                                            <div class="ms-pro-rat-price">
                                                <span class="ms-pro-rating">
                                                    <i class="msicon msi-star fill"></i>
