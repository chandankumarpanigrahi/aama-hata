                ...
                <div class="col-12">
                    <div class="row ms_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ms-breadcrumb-title">Login Page</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ms-breadcrumb-list start -->
                            <ul class="ms-breadcrumb-list">
                                <li class="ms-breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="ms-breadcrumb-item active">Login Page</li>
                            </ul>
    ...
    <section class="ms-login padding-tb-30">
        <div class="container">
            <div class="section-title-2">
                <h2 class="ms-title">Login<span></span></h2>
            ...
            <div class="ms-login-content p-t-15">
                        ...
                        <div class="ms-login-container">
                            <div class="ms-login-form">
                                <form action="#" method="post">
                                    ...
                                    <span class="ms-login-wrap ms-login-fp">
                                        <label><a href="#">Forgot Password?</a></label>
                                    </span>
                                    <span class="ms-login-wrap ms-login-btn">
                                        <span><a href="register.php" class="">Create Account?</a></span>
                                        <button class="ms-btn-2 btn" type="submit">Login</button>
                                    </span>
                                </form>
                            </div>
                        </div>
                ...
                <div class="ms-login-box d-n-991">
