            ...
            <div class="col-12">
                <div class="row ms_breadcrumb_inner">
                    <div class="col-md-6 col-sm-12">
                        <h2 class="ms-breadcrumb-title">About Us</h2>
                    </div>
                    <div class="col-md-6 col-sm-12">
                        <!-- ms-breadcrumb-list start -->
                        <ul class="ms-breadcrumb-list">
                            <li class="ms-breadcrumb-item"><a href="index.php">Home</a></li>
                            <li class="ms-breadcrumb-item active">About Us</li>
                        </ul>
...
<section class="ms-service-section padding-tb-30">
    <div class="container">
        ...
        <div class="row m-tb-minus-12 p-t-15">
                        ...
                        <ul id="ms-testimonial-slider" class="owl-carousel">
                            <li class="ms-test-item">
                                ...
                                <div class="ms-test-inner">
                                    ...
                                    <div class="ms-test-content">
                                        <div class="ms-test-desc">Lorem Ipsum is simply dummy text of the printing
                                            and
                            ...
                            <li class="ms-test-item ">
                                ...
                                <div class="ms-test-inner">
                                    ...
                                    <div class="ms-test-content">
                                        <div class="ms-test-desc">standard dummy text
                            ...
                            <li class="ms-test-item">
                                ...
                                <div class="ms-test-inner">
                                    ...
                                    <div class="ms-test-content">
                                        <div class="ms-test-desc">when an unknown printer took a galley of type and
...
<!-- Facts Section -->
<section class="ms-facts-section padding-tb-30">
    <div class="container">
        <div class="row m-tb-minus-12">
            <div class="ms-facts-content col-sm-12 col-md-6 col-lg-3 p-tp-12">
                <div class="ms-facts-inner">
                    <div class="ms-count">
                        <span class="counter">25K+</span>
                    </div>
                    <div class="ms-facts-desc">
                        <h4>Vendors</h4>
...
<!-- Team Section -->
<section class="ms-team-section padding-tb-30">
    <div class="container">
        <div class="section-title-2">
            <h2 class="ms-title">Our <span>Team</span></h2>
            <p>Meet out expert team members.</p>
        </div>
        <div class="ms-team owl-carousel p-t-15">
            <div class="ms-team-box">
                <div class="ms-team-imag">
                    <img src="assets/img/user/4.jpg" alt="user">
                    <div class="ms-team-socials">
                        <ul class="align-items-center">
                            <li class="ms-social-link">
                                <a href="#"><i class="msicon msi-twitter" aria-hidden="true"></i></a>
                            </li>
                            <li class="ms-social-link">
                                <a href="#"><i class="msicon msi-facebook" aria-hidden="true"></i></a>
                            </li>
                            <li class="ms-social-link">
                                <a href="#"><i class="msicon msi-linkedin" aria-hidden="true"></i></a>
                            </li>
                        </ul>
                    </div>
                </div>
