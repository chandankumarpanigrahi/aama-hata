...
?>
                ...
                <div class="col-12">
                    <div class="row ms_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ms-breadcrumb-title">Compare</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ms-breadcrumb-list start -->
                            <ul class="ms-breadcrumb-list">
                                <li class="ms-breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="ms-breadcrumb-item active">Compare</li>
                            </ul>
    ...
    <!-- Compare section -->
    <section class="ms-compare padding-tb-30">
        <h2 class="d-none">Compare</h2>
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="ms-compare-box">
                        <div class="ms-compare-col title-col">
                            <div class="ms-compare-cell">
                                <div class="title">
                                    <h5>Product Image</h5>
                                </div>
                            </div>
                        ...
                        <div class="ms-compare-col">
                            <a href="javascript:void(0)" class="remove-compare-product"><img src="assets/img/icons/close.svg" class="svg_img" alt="close"></a>
                            <div class="ms-compare-cell">
                                <div class="list">
                                    <img src="assets/img/product-images/8_1.jpg" alt="product">
                                    <div class="ms-action">
                                        <ul>
                                            <li><a href="javascript:void(0)" class="wishlist" title="Wishlist"><img src="assets/img/icons/wishlist.svg" class="svg_img" alt="wishlist"></a></li>
                                            <li><a href="javascript:void(0)" class="add-to-cart" title="Add To Cart"><img src="assets/img/icons/cart_5.svg" class="svg_img" alt="cart"></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="ms-compare-col">
                            ...
                            <div class="ms-compare-cell">
                                <div class="list">
                                    <img src="assets/img/product-images/4_1.jpg" alt="product">
                                    <div class="ms-action">
                                        <ul>
                                            <li><a href="javascript:void(0)" class="wishlist" title="Wishlist"><img src="assets/img/icons/wishlist.svg" class="svg_img" alt="wishlist"></a></li>
                                            <li><a href="javascript:void(0)" class="add-to-cart" title="Add To Cart"><img src="assets/img/icons/cart_5.svg" class="svg_img" alt="cart"></a></li>
