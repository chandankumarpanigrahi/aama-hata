...
?>
                ...
                <div class="col-12">
                    <div class="row ms_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ms-breadcrumb-title">Terms & Condition</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ms-breadcrumb-list start -->
                            <ul class="ms-breadcrumb-list">
                                <li class="ms-breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="ms-breadcrumb-item active">Terms & Condition</li>
                            </ul>
    ...
    <!-- Terms section -->
    <section class="ms-terms-conditions padding-tb-30">
        <div class="container">
            <div class="section-title-2">
                <h2 class="ms-title"><span>Terms</span> & Condition</h2>
                <p>Browse The Collection of Top Products</p>
            </div>
            <div class="row p-t-15">
                <div class="col-lg-6">
                    <div class="ms-common-wrapper">
                        <div class="col-sm-12 ms-cms-block">
                            <div class="ms-cms-block-inner">
                                <h5 class="ms-cms-block-title">Welcome to Masterkart Store.</h5>
                        ...
                        <div class="col-sm-12 ms-cms-block">
                            <div class="ms-cms-block-inner">
                                <h5 class="ms-cms-block-title">Master kart Websites</h5>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. <b>Lorem
                                        Ipsum is simply dutmmy text</b> ever since the 1500s, when an unknown printer
                                    took a galley of type and scrambled it to make a type specimen book. It has survived
                                    not only five centuries, but also the leap into electronic typesetting, remaining
                        ...
                        <div class="col-sm-12 ms-cms-block">
                            <div class="ms-cms-block-inner">
                                <h5 class="ms-cms-block-title">How browsing and vendor works?</h5>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. <b>Lorem
                                        Ipsum is simply dutmmy text</b> ever since the 1500s, when an unknown printer
                                    took a galley of type and scrambled it to make a type specimen book. It has survived
                                    not only five centuries, but also the leap into electronic typesetting, remaining
                        ...
                        <div class="col-sm-12 ms-cms-block">
                            <div class="ms-cms-block-inner">
                                <h5 class="ms-cms-block-title">Becoming an vendor</h5>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. <b>Lorem
                                        Ipsum is simply dutmmy text</b> ever since the 1500s, when an unknown printer
                                    took a galley of type and scrambled it to make a type specimen book. It has survived
                                    not only five centuries, but also the leap into electronic typesetting, remaining
                ...
                <div class="col-lg-6 m-t-991">
                    <div class="ms-accordion style-1">
                        <div class="ms-accordion-item">
                            <h4 class="ms-accordion-header">
                                What is the multi vendor services?
                            </h4>
                            <div class="ms-accordion-body show">Lorem Ipsum is simply dummy text of the printing and
                        ...
                        <div class="ms-accordion-item">
                            ...
                            <div class="ms-accordion-body">Lorem Ipsum is simply dummy text of the printing and
                                typesetting industry. Lorem
                    ...
                    <div class="ms-common-wrapper m-t-30">
                        <div class="col-sm-12 ms-cms-block">
                            <div class="ms-cms-block-inner">
                                <h5 class="ms-cms-block-title">How browsing and vendor works?</h5>
                                <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. <b>Lorem
