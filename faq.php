...
?>
                ...
                <div class="col-12">
                    <div class="row ms_breadcrumb_inner">
                        <div class="col-md-6 col-sm-12">
                            <h2 class="ms-breadcrumb-title">Faq Page</h2>
                        </div>
                        <div class="col-md-6 col-sm-12">
                            <!-- ms-breadcrumb-list start -->
                            <ul class="ms-breadcrumb-list">
                                <li class="ms-breadcrumb-item"><a href="index.php">Home</a></li>
                                <li class="ms-breadcrumb-item active">Faq Page</li>
                            </ul>
    ...
    <!-- Faq section -->
    <section class="ms-faq padding-tb-30">
        <div class="container">
            <div class="section-title-2">
                <h2 class="ms-title">frequently asked <span>questions</span></h2>
                <p>Customer service management.</p>
            </div>
            <div class="row p-t-15">
                <div class="col-lg-6">
                    <div class="section-title-3">
                        <h2 class="ms-title">Exchange <span>Product</span></h2>
                    </div>
                    <div class="ms-accordion style-1 p-t-15">
                ...
                <div class="col-lg-6 m-t-991">
                    <div class="section-title-3">
                        <h2 class="ms-title">Return <span>Product</span></h2>
                    </div>
                    <div class="ms-accordion style-1 p-t-15">
                        <div class="ms-accordion-item">
                            <h4 class="ms-accordion-header">
