                ...
                <div class="row align-items-center">
                        ...
                        <div class="header-top-social">
                            <ul class="mb-0">
                                <li class="list-inline-item">
                                    <a href="javascript:void(0)"><i class="msicon msi-phone"></i></a>+91 82492 87967
                                </li>
                                <!-- <li class="list-inline-item">
                    ...
                    <div class="col header-top-right d-none d-lg-block">
                        <div class="header-top-right-inner d-flex justify-content-end">
                            ...
                            <!-- Currency End -->
                            <a class="ms-help" href="faq.php">Help?</a>
                            <a class="ms-help" href="track-order.php">Track Order?</a>
                        </div>
                    </div>
                    <!-- Header Top Language Currency -->
                    ...
                    <div class="col header-top-res d-lg-none">
                        <div class="ms-header-bottons">
                            ...
                            <div class="right-icons">
                                <!-- Header User Start -->
                                <a href="login.php" class="ms-header-btn ms-header-user">
                                ...
                                <a href="javascript:void(0)" class="ms-header-btn ms-wish-toggle">
                                    <div class="header-icon"><img src="assets/img/icons/wishlist.svg"
                                            class="svg_img header_svg" alt=""></div>
                                ...
                                <a href="javascript:void(0)" class="ms-header-btn ms-cart-toggle">
                                    <div class="header-icon"><img src="assets/img/icons/pro_cart.svg"
                    ...
                    <div class="ms-flex">
                        ...
                        <div class="align-self-center ms-header-logo">
                            <div class="header-logo">
                                <a href="index.php"><img src="assets/img/logo/logo.png" alt="Site Logo"></a>
                            </div>
                        </div>
                        <!-- Header Logo End -->
                            ...
                            <div class="header-search">
                                <form class="ms-search-group-form" action="#">
                                    <div class="ms-search-select-inner">
                                        <select class="ms-search-cat selectpicker" multiple data-live-search="true"
                                            data-live-search-placeholder="Search category" data-actions-box="true">
                                        ...
                                        <ul>
                                                    ...
                                                    <li class="d-flex">
                                                        ...
                                                        <ul class="d-block">
                                                            <li class="menu_title"><a
                                                                    href="javascript:void(0)">Classic</a></li>
                                                            <li><a href="shop-left-sidebar-col-3.php">Left sidebar 3
                                                                    column</a>
                                                            </li>
                                                            <li><a href="shop-left-sidebar-col-4.php">Left sidebar 4
                                                                    column</a>
                                                            </li>
                                                            <li><a href="shop-right-sidebar-col-3.php">Right sidebar 3
                                                                    column</a>
                                                            </li>
                                                            <li><a href="shop-right-sidebar-col-4.php">Right sidebar 4
                                                                    column</a>
                                                            </li>
                                                            <li><a href="shop-full-width.php">Full width 4 column</a>
                                                            </li>
                                                        </ul>
                                                        <ul class="d-block">
                                                            <li class="menu_title"><a
                                                                    href="javascript:void(0)">Banner</a></li>
                                                            <li><a href="shop-banner-left-sidebar-col-3.php">left
                                                                    sidebar 3
                                                                    column</a></li>
                                                            <li><a href="shop-banner-left-sidebar-col-4.php">left
                                                                    sidebar 4
                                                                    column</a></li>
                                                            <li><a href="shop-banner-right-sidebar-col-3.php">right
                                                                    sidebar
                                                                    3 column</a></li>
                                                            <li><a href="shop-banner-right-sidebar-col-4.php">right
                                                                    sidebar
                                                                    4 column</a></li>
                                                            <li><a href="shop-banner-full-width.php">Full width 4
                                                                    column</a>
                                                            </li>
                                                        </ul>
                                                        <ul class="d-block">
                                                            <li class="menu_title"><a
                                                                    href="javascript:void(0)">Columns</a></li>
                                                            <li><a href="shop-full-width-col-3.php">3 Columns full
                                                                    width</a></li>
                                                            <li><a href="shop-full-width-col-4.php">4 Columns full
                                                                    width</a></li>
                                                            <li><a href="shop-full-width-col-5.php">5 Columns full
                                                                    width</a></li>
                                                            <li><a href="shop-full-width-col-6.php">6 Columns full
                                                                    width</a></li>
                                                            <li><a href="shop-banner-full-width-col-3.php">Banner 3
                                                                    Columns</a>
                                                            </li>
                                                        </ul>
                                                        <ul class="d-block">
                                                            ...
                                                            <li><a href="shop-list-left-sidebar.php">Shop left
                                                                    sidebar</a></li>
                                                            <li><a href="shop-list-right-sidebar.php">Shop right
                                                                    sidebar</a></li>
                                                            <li><a href="shop-list-banner-left-sidebar.php">Banner left
                                                                    sidebar</a>
                                                            </li>
                                                            <li><a href="shop-list-banner-right-sidebar.php">Banner
                                                                    right
                                                                    sidebar</a></li>
                                                            <li><a href="shop-list-full-col-2.php">Full width 2
                                                                    columns</a></li>
                                                        </ul>
                                                    </li>
                                                </ul>
                                            ...
                                            <li class="dropdown drop-list">
                                                <a href="javascript:void(0)" class="dropdown-arrow">Products<i
                                                        class="msicon msi-angle-right"></i></a>
                                                <ul class="sub-menu">
                                                    <li><a href="product-left-sidebar.php">Product left sidebar</a>
                                                    </li>
                                                    <li><a href="product-right-sidebar.php">Product right sidebar</a>
                                                    </li>
                                            ...
                                            <li class="dropdown drop-list">
                                                ...
                                                <ul class="sub-menu">
                                                    ...
                                                    <li><a href="blog-detail-left-sidebar.php">Detail left sidebar</a>
                                                    </li>
                                                    <li><a href="blog-detail-right-sidebar.php">Detail right
                                                            sidebar</a></li>
                                            ...
                                            <li class="non-drop"><a href="discover.php"><img
                                                        src="assets/img/icons/discover.svg" class="svg_img"
                                                        alt="discover">Discover</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <ul class="loc-grid">
                                            <li class="loc-list current">
                                                <img src="assets/img/icons/location.svg"
                                                    ...
                                                    class="ms-detail-current">current Location</span>
                                            </li>
                                            <li class="loc-list"><img src="assets/img/icons/location.svg"
                                                    class="svg_img header_svg svg_loc" alt="icon"><span
